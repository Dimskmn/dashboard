...
# Load Berkas all_df
all_df = pd.read_csv(
    "https://raw.githubusercontent.com/Dimskmn/dashboard/refs/heads/main/BikeShare/day_bikeshare_clean.csv")
...
sns.barplot(data=renters_df, x='year', y='Count',
            hue='User Type', palette=["#DD9D9E", "#BA3B3D"])
...
# Menampilkan Visualisasi Clustering
